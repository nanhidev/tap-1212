...
Feature: OpenCreateNewJobOpeningFor
  ...
  Examples:
    ...
    | Example Title | Example Description | Example Requirements | Example Information |
...
Scenario Outline: Open Create New Job Opening Form
  When I click on the Add Job Opening button to open the form
  And I use a screen reader to navigate through the form fields
